...
fn usage() void {
    std.debug.print(
        ...
        \\  cloudio export
        \\  cloudio coverage summary|tags|l1|gaps|routes [all|cloudflare|hostinger] [tag-query] [--limit <n>] [--operation <id>] [--method <method>] [--path <template>] [--support <status>] [--mode <mode>]
