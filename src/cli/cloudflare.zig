...
const cloudflare_options = @import("cli_cloudflare_options");
const cloudflare_dry_run = @import("cli_cloudflare_dry_run");
...
const applyAuditLogReadFilter = cloudflare_options.applyAuditLogReadFilter;
const applyCloudforceOneRuleFilter = cloudflare_options.applyCloudforceOneRuleFilter;
const applyEmailRoutingAccountFilter = cloudflare_options.applyEmailRoutingAccountFilter;
const applyEmailRoutingZoneFilter = cloudflare_options.applyEmailRoutingZoneFilter;
const applyEmailSecuritySettingsFilter = cloudflare_options.applyEmailSecuritySettingsFilter;
const applyIpAccessRuleFilter = cloudflare_options.applyIpAccessRuleFilter;
const applyLogExplorerReadFilter = cloudflare_options.applyLogExplorerReadFilter;
const applyLogsReceivedReadFilter = cloudflare_options.applyLogsReceivedReadFilter;
const applyPageShieldFilter = cloudflare_options.applyPageShieldFilter;
const applySecurityCenterReadFilter = cloudflare_options.applySecurityCenterReadFilter;
const applyTlsReadFilter = cloudflare_options.applyTlsReadFilter;
const applyZeroTrustReadFilter = cloudflare_options.applyZeroTrustReadFilter;
const isKeyValue = cloudflare_options.isKeyValue;
const isOverviewCommand = cloudflare_options.isOverviewCommand;
const parseOverviewArgs = cloudflare_options.parseOverviewArgs;
...
fn commandDryRun(ctx: Context, args: []const []const u8) !void {
    return try cloudflare_dry_run.run(dryRunContext(ctx), args);
}
...
fn dryRunContext(ctx: Context) cloudflare_dry_run.Context {
    return .{
        .io = ctx.io,
        .gpa = ctx.gpa,
        .auth = ctx.auth,
