...
pub const app = struct {
    ...
    pub const evidence_routes = @import("app_evidence_routes");
...
pub const providers = struct {
    ...
    pub const typed_routes = @import("provider_typed_routes");
...
test "facade exposes stable integration modules" {
    ...
    _ = app.evidence_common.ProviderFilter;
    _ = app.evidence_routes.RouteCaptures;
    _ = app.evidence_routes.RouteCoverage;
    _ = app.evidence_routes.RouteCaptureSummary;
    ...
    _ = providers.typed_routes.DryRunPlan;
