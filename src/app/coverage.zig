...
fn cloudflareRouteScope(route: provider_routes.Route, request: Request) CloudflareRouteScope {
...
fn pathParamValue(request: Request, name: []const u8) ?[]const u8 {
...
fn firstPathParamValue(request: Request) ?[]const u8 {
