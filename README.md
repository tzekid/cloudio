...
The `coverage gaps`, `coverage levels`, and `coverage level-tags` review surfaces accept `--json` or `--format json` for future web/native UI callers without scraping CLI text.
