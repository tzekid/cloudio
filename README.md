...
`coverage typed-models` ranks tag groups where generic L3 inventory rows exist but typed SQLite projections are missing or thin, with family filters and route/workplan commands for the next broad modeling slice.
