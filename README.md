...
The `coverage l1`, `coverage gaps`, `coverage levels`, `coverage level-tags`, and `coverage routes` review surfaces accept `--json` or `--format json` for future web/native UI callers without scraping CLI text.
